...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_get_recripe_detail(self):
    ...
    def test_full_update(self):
        ...
        recipe = create_recipe(
            ...
            link='http://example.com/recipe.pdf',
            title='Sample recipe title',
            description='Sample recipe descriptiton',
        )
        payload = {
    ...
    def test_update_user_eror(self):
        """Test update user return an error."""
    ...
    def test_delete_other_user_recipe_error(self):
        """Test trying to delete others users recipe reurns error."""
    ...
    def test_create_recipe_with_existing_ingredient(self):
        """Test crating a new recipe with existing ingredient."""
    ...
    def test_update_recipe_assign_ingredient(self):
        """Test assign an existing ingredient whenupdating a recipe."""
    ...
    def test_filter_by_tags(self):
        ...
        tag2 = Tag.objects.create(user=self.user, name='Vegetatrian')
        r1.tags.add(tag1)
        r2.tags.add(tag2)
